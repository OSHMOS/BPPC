...
from bppc_right import BPPC
from visualize_bppc_right import Visualize_BPPC
...
if __name__ == '__main__':
    ...
    # # right
    input_folder = 'data/images/right_final/'
    ...
    for model_name in model_names:
        ...
        for folder_number in folders:
            ...
            ####
            gt_kpts = np.load(f'data/gt_2D/right/{folder_number}_gt.npz')["keypoints"]
        ...
        #     results_dir = f'demo/output/conf_results/right/{model_name}/{folder_number}'
        ...
        # last_results_dir = f'demo/output/conf_results/right/{model_name}'
        ...
        os.makedirs(f'demo/output/basic_results/right/{model_name}', exist_ok=True)
        with open(f'demo/output/basic_results/right/{model_name}/results.txt', 'w') as f:
            f.write(table)
