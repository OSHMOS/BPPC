...
from lib.backbone.gen_kpts_resnet152 import gen_video_kpts as resnet152_pose
...
def get_pose2D(video_path):
    ...
    with torch.no_grad():
        ...
        # keypoints, scores, output = hrnet_pose(video_path, det_dim=416, num_person=1, gen_output=True)
        keypoints, scores, output = resnet152_pose(video_path, det_dim=416, num_person=1, gen_output=True)
...
def img2video(video_path, number, output_dir='demo/output/backbone/res152/'):
    ...
    folders = [f'demo/output/backbone/res152/{number}/res152/', f'demo/output/backbone/res152/{number}/apc/', f'demo/output/backbone/res152/{number}/sm/', f'demo/output/backbone/res152/{number}/gt/']
    # mlb
