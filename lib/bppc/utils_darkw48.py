...
from lib.backbone.gen_kpts_darkw48 import gen_video_kpts as hrnet_pose
...
def img2video(video_path, number, output_dir='demo/output/backbone/darkw48/'):
    ...
    folders = [f'demo/output/backbone/darkw48/{number}/darkw48/', f'demo/output/backbone/darkw48/{number}/apc/', f'demo/output/backbone/darkw48/{number}/sm/', f'demo/output/backbone/darkw48/{number}/gt/']
    # mlb
