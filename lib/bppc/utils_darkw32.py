...
from lib.backbone.gen_kpts_darkw32 import gen_video_kpts as hrnet_pose
...
def img2video(video_path, number, output_dir='demo/output/backbone/darkw32/'):
    ...
    folders = [f'demo/output/backbone/darkw32/{number}/darkw32/', f'demo/output/backbone/darkw32/{number}/apc/', f'demo/output/backbone/darkw32/{number}/sm/', f'demo/output/backbone/darkw32/{number}/gt/']
    # mlb
