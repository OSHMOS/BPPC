...
from lib.backbone.gen_kpts_hw48 import gen_video_kpts as hrnet_pose
...
def img2video(video_path, number, output_dir='demo/output/backbone/hw48/'):
    ...
    folders = [f'demo/output/backbone/hw48/{number}/hw48/', f'demo/output/backbone/hw48/{number}/apc/', f'demo/output/backbone/hw48/{number}/sm/', f'demo/output/backbone/hw48/{number}/gt/']
    # mlb
