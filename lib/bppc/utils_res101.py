...
from lib.backbone.gen_kpts_resnet101 import gen_video_kpts as resnet101_pose
...
def get_pose2D(video_path):
    ...
    with torch.no_grad():
        ...
        keypoints, scores, output = resnet101_pose(video_path, det_dim=416, num_person=1, gen_output=True)
...
def img2video(video_path, number, output_dir='demo/output/backbone/res101/'):
    ...
    folders = [f'demo/output/backbone/res101/{number}/res101/', f'demo/output/backbone/res101/{number}/apc/', f'demo/output/backbone/res101/{number}/sm/', f'demo/output/backbone/res101/{number}/gt/']
    # mlb
