...
from lib.backbone.gen_kpts_hw32 import gen_video_kpts as hrnet_pose
...
def img2video(video_path, number, output_dir='demo/output/backbone/hw32/'):
    ...
    folders = [f'demo/output/backbone/hw32/{number}/hw32/', f'demo/output/backbone/hw32/{number}/apc/', f'demo/output/backbone/hw32/{number}/sm/', f'demo/output/backbone/hw32/{number}/gt/']
    # mlb
