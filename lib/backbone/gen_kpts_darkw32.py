...
from lib.backbone.lib.dark_config import cfg, update_config
from lib.backbone.lib.utils.transforms import *
from lib.backbone.lib.utils.inference import get_final_preds
from lib.backbone.lib.models import pose_hrnet

cfg_dir = 'lib/backbone/experiments/darkpose/'
model_dir = 'lib/checkpoint/darkpose/'
...
def parse_args():
    ...
    parser.add_argument('--modelDir', type=str, default=model_dir + 'w32_384×288.pth',
...
def gen_video_kpts(video, det_dim=416, num_person=1, gen_output=False):
    ...
    return keypoints, scores, pose_darkpose_output # for accuracy
